...
public class OTOUniAssociationTest extends TwinAssociation {
	...
	protected void find() {
		// Find Person
		try {
			PersonnelUni1To1FK p = (PersonnelUni1To1FK) dao.findPerson(
					PersonnelUni1To1FK.class, "unionetoonefk_1");
	...
	@Override
	public void loadDataForPERSONNEL() throws InvalidRequestException,
	...
	@Override
	public void loadDataForHABITAT() throws TException,
