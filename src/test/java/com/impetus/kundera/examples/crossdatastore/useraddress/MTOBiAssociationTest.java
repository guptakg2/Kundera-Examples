...
public class MTOBiAssociationTest extends TwinAssociation {
	...
	protected void find() {
		// Find Person 1
		PersonnelBiMTo1 p1 = (PersonnelBiMTo1) dao.findPerson(
				PersonnelBiMTo1.class, "bimanytoone_1");
		...
		// Find Person 2
		PersonnelBiMTo1 p2 = (PersonnelBiMTo1) dao.findPerson(
				PersonnelBiMTo1.class, "bimanytoone_2");
	...
	/* (non-Javadoc)
	 * @see com.impetus.kundera.examples.crossdatastore.useraddress.TwinAssociation#update()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.impetus.kundera.examples.crossdatastore.useraddress.TwinAssociation#remove()
	 */
	@Override
