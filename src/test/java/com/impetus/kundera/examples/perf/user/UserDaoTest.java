...
public class UserDaoTest extends TestCase {
	...
	private void init() {
		...
		userDao.init();
		/*
		 * // super.setUp(); userDao = UserDaoFactory.getUserDao("kundera"); //
		 * hector and pelops userDao.init();
		 * 
	 ...
	 */
	// @Repeat(times = 400000)
	public void testInsertWithMaxConcurUsrs() throws Exception/*
															 * throws
															 ...
															 */
	{
		...
		// init();
		int cnt = 1;
		for (final UserMongoDTO user : prepareDataSet(40000)) {
			...
			// System.out.println("Kundera Performance: MaxinsertUsers(" + 40000
			// + ")>>>\t" + cnt++);
		}
		long t2 = System.currentTimeMillis();
		System.out.println("Kundera Performance: MaxinsertUsers(" + 40000
	...
	/*
	 * public void testInsertWithMaxConcurUsrKundera() {thread
	 * prepareDataSet(40000) }
	 *//**
	 * Case 0: Boundary condition (1-40000 records) Case 1: Insert batch Case
	 * 2: Concurrent Users Case 3: Shorter transaction for Batch of objects.
	 * (Worst case scenario). TODO: lucene performance enhancement.
	 */
	/*
	 * public void testInsertUser() { for (int i = 0; i < 20000; i++) { UserDTO
	 * user = new UserDTO(); user.setUserId("userId_" + i);
	 * user.setUserName("Amry_" + i); user.setPassword("password_" + i);
